...
('Tral Balığı', 'Atlantic Stargazer', 'deniz', true),
('Züber', 'Leerfish', 'göç', true),
('Plaka Gridası', 'Golden Grouper', 'deniz', true),
('Fare Balığı', 'Picarel', 'deniz', true),
('Liça', 'Leerfish', 'göç', true),
('Domuz Balığı', 'White Seabream', 'deniz', true),
('Aslan Balığı', 'Lionfish', 'deniz', true),
('Gargur', 'Parrotfish', 'deniz', true),
('Balon Balığı', 'Pufferfish', 'deniz', true),
('Yazılı', 'Painted Comber', 'deniz', true),
('Baraküda', 'Barracuda', 'deniz', true),
('Lokum Balığı', 'Parrotfish', 'deniz', true),
('Deve Balığı', 'Stargazer', 'deniz', true),
('Ceylan Balığı', 'Amberjack', 'göç', true),
('İbikli', 'Comber', 'deniz', true)
